...
isset($_POST['contact-input-message']))) {
    echo json_encode(array('result' => false, 'message' => 'Niekompletny formularz.')); // brak wszystkich dnaych
    }
...
{
    echo json_encode(array('result' => false, 'message' => 'Email '.$askerMailAddress.' jest nieprawidłowy.')); 
}
